...
from ..utils.text_utils import draw_message_componet
...
class Dinosaurs(Sprite):
    ...
    def check_invencibility(self):
        if self.shield:
            ...
            if time_to_show >= 0 and self.show_text:
                draw_message_componet(f'Shield enabled for {time_to_show}', screen, font_size=18, pos_x_center=500, pos_y_center = 40)
    ...
    def check_power(self):
        if self.hammer:
            ...
            if time_to_show >= 0 and self.show_text:
                draw_message_componet(f'Hammer enabled for {time_to_show}', screen, font_size=18, pos_x_center=500, pos_y_center = 40)
